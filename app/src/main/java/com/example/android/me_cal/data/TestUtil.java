...
public class TestUtil {
    ...
    public static void insertFakeData(SQLiteDatabase db){
        ...
        cv.put(AddTaskContract.AddTaskEntry.COLUMN_TASK_TIME_START, "260820171000");
        ...
        cv.put(AddTaskContract.AddTaskEntry.COLUMN_TASK_TIME_START, "26/08/2017 13:00:00");
        cv.put(AddTaskContract.AddTaskEntry.COLUMN_TASK_NAME, "lunch");
        list.add(cv);

        cv = new ContentValues();
        cv.put(AddTaskContract.AddTaskEntry.COLUMN_TASK_TIME_START, "26/08/2017 15:00:00");
        cv.put(AddTaskContract.AddTaskEntry.COLUMN_TASK_NAME, "snack");
        list.add(cv);

        cv = new ContentValues();
        cv.put(AddTaskContract.AddTaskEntry.COLUMN_TASK_TIME_START, "26/08/2017 18:00:00");
        cv.put(AddTaskContract.AddTaskEntry.COLUMN_TASK_NAME, "dinner");
        list.add(cv);

        cv = new ContentValues();
        cv.put(AddTaskContract.AddTaskEntry.COLUMN_TASK_TIME_START, "26/08/2017 22:00:00");
